...
export const selectIsUsedCardsFilter = (state: AppRootStateType): boolean => state.cards.isUsedCardsFilter
export const selectRerenderFlag = (state: AppRootStateType): Array<string> => state.cards.rerenderFlag
