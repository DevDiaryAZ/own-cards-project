...
export const authAPI = {
    ...
    registration(email: string, password: string) {
        return instance.post<{
            email: string
            password: string
        }, AxiosResponse<TResponseAuthData>>('/auth/register', {
            email,
            password
        })
    },
    login(email: string, password: string, rememberMe: boolean) {
        return instance.post<{
            ...
            password: string
            rememberMe: boolean
        }, AxiosResponse<TResponseAuthData>>('/auth/login', {
    ...
    changeName(newName: string) {
        return instance.put<{
            name: string
        }, AxiosResponse<TResponseAuthData>>('/auth/me', {
            name: newName
        })
    },
    changeAvatar() {
    ...
    forgot(email: string) {
        ...
        return axios.create({
            ...
            email: string
            message: string
        }, AxiosResponse<TResponseAuthData>>('/auth/forgot', data)
    },
    setNewPassword(password: string, resetPasswordToken: string) {
        ...
        }, AxiosResponse<TResponseAuthData>>('/auth/set-new-password', {
            password,
            resetPasswordToken
        })
    }
