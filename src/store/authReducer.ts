...
export type AuthActionType = IsAuthACType | IsRegisteredACACType | SetErrorMessageACType | IsLetterWasSentACType | IsNewPasswordWasSetACType
...
export const registrationTC = (email: string, password: string): AppThunk => async dispatch => {
    try {
...
export const updatePasswordTC = (password: string, resetPasswordToken: string): AppThunk => async dispatch => {
    try {
