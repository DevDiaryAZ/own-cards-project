...
export const selectIsLetterWasSent = (state: AppRootStateType): boolean =>
  state.auth.isLetterWasSent
export const selectIsRegistered = (state: AppRootStateType): boolean => state.auth.isRegistered
export const selectIsNewPasswordWasSet = (state: AppRootStateType): boolean =>
  state.auth.isNewPasswordWasSet
